! function(a) {
    a.fn.stellarNav = function(n, i, s) {
        ...
        var e = a.extend({ theme: "plain", breakpoint: 768, phoneBtn: !1, locationBtn: !1, sticky: !1, position: "static", showArrows: !0, closeBtn: !1, scrollbarFix: !1 }, n);
        return this.each(function() {
            ...
            if (e.sticky && (navPos = nav.offset().top, i >= s && a(window).bind("scroll", function() { a(window).scrollTop() > navPos ? nav.addClass("fixed") : nav.removeClass("fixed") })), "top" == e.position && nav.addClass("top"), "left" == e.position || "right" == e.position) {
            ...
            var d = function() { nav.find("li").unbind("mouseenter"), nav.find("li").unbind("mouseleave") },
                v = function() { nav.find("li").on("mouseenter", function() { a(this).addClass("hover"), a(this).children("ul").stop(!0, !0).slideDown(250) }), nav.find("li").on("mouseleave", function() { a(this).removeClass("hover"), a(this).children("ul").stop(!0, !0).slideUp(250) }) };
            n(), a(window).on("resize", function() { n() })
        })
    }
}(jQuery);